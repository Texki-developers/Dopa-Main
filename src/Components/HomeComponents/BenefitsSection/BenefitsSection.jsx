    ...
    <section className={styles["benefits-section"]}>
      <div className={styles["benefits-container"]}>
        <div>
          <ul className={styles["benefits-selector-wrapper"]}>
            <li
              className={
                styles["benefits-selector"] +
                " " +
                (sliderStatus[0] === 0
                  ? styles["benefits-selector--active"]
                  : "")
              }
          ...
          <Button className="btn-solid border-[1px] w-[100%] text-white font-[600] bg-primary-400 shadow-[0px_3.42px_3.42px_0px_#00000040]">
            Download Now
          </Button>
        </div>
        ...
        <div className={styles.benefit_slider_container}>
          <div
            className={styles.benefit_slider_wrapper}
            style={{ transform: `translateX(${sliderStatus[1]}px)` }}
          >
            <Carousel>
              <InnovativeApproach />
            </Carousel>
            ...
            <div className={styles.benefit_child} ref={sliderChildRef}>
              <div className={styles.benefit_left}>
                <div className={styles.benefits_title_wrapper}>
                  <h3 className="banner-subtitle font-[600]">
                ...
                <p>
                  Doctor-led mentorship program for NEET coaching students
                  provides expert guidance and personalized support to help
                  aspiring medical students succeed on the competitive exam.
                  Include study materials, practice tests and strategies for
                  managing stress. Helps students realize their full potential.
                </p>
              </div>
            ...
            <div className={styles.benefit_child}>
              <div className={styles.benefit_left}>
                <div className={styles.benefits_title_wrapper}>
                  <h3 className="banner-subtitle font-[600]">
                    NEET success with ease Streamlined approach
                  </h3>
                </div>
                <p>
                  Looking to excel on the NEET exam? Our success program can
                  help you get there. Our expert-designed program includes a
                  doctor's success planner, weekly exams, and tracking and
                  analysis of scores to keep you focused and on track. With our
                  proven approach, you can achieve NEET success with confidence.
                </p>
                <button className="btn-primary" onClick={downloadDoctorPDF}>
                  Download Doctor’s success planner
                </button>
              </div>
              ...
              <div className={styles["phone-img-wrapper"]}>
                ...
                <Image
                  src={systematicStrategy}
                  className={styles["r-img-system"]}
                  alt="Doctor Led Mentorship"
                />
              </div>
            </div>
            ...
            <Carousel dots={true}>
              <div className={styles.benefit_child}>
                <div className={styles.benefit_left}>
                  <div className={styles.benefits_title_wrapper}>
                    <h3 className="banner-subtitle font-[600]">
                      Excel in Your Studies by Learn from the Doctors.
                    </h3>
                  </div>
                  <p>
                    Our elite tutors are experts in their field, with a wealth
                    of knowledge and experience in preparing students for the
                    NEET. We understand that NEET is a challenging exam and
                    requires a tailored approach to learning. Our tutors work
                    with you to identify your strengths and weaknesses and
                  ...
                  <button
                    ...
                    onClick={() =>
                      (window.location.href =
                        "https://admin.mydopaclass.com/download")
                    }
                  >
              ...
              <div className={styles.benefit_video_wrapper}>
                <iframe
                  src="https://www.youtube.com/embed/UDONpqGU4gs"
      ...
      <div className={styles["benefits-container-mobile"]}>
        <ul className={styles.benefit_mobile_selector}>
          <li
            className="benefit_mobile_selector__active"
            onClick={(e) => mobileSelectionHandler(e, 0)}
          >
            <span>Innovative Approach</span>
          </li>
          <li onClick={(e) => mobileSelectionHandler(e, 1)}>
            <span>Mentorship by Doctors</span>
          </li>
          <li onClick={(e) => mobileSelectionHandler(e, 2)}>
            <span>Systematic Strategy</span>
          </li>
          <li onClick={(e) => mobileSelectionHandler(e, 3)}>
            <span>Elite Tutors</span>
          </li>
        </ul>
        ...
        <div className={styles.benefits_container_slider_wrapper}>
          {mobileActiveIndex === 0 ? (
            <div className={styles.benefits_container_slider}>
              <Carousel
                itemsPerWindow={isMobile ? false : 2}
                dots={isMobile ? true : false}
                gap={16}
              >
                <div
                  className={
                    styles.benefits_mobile_slide_card +
                    " " +
                    styles.benefits_card_colored
                  }
                >
                  <div className={styles.benefits_title_wrapper}>
                  ...
                  <p>
                    The DOPA app helps you prepare for the NEET exam with
                    personalized lessons and support. Whether you're new to the
                    exam or have experience, the app gives you the tools you
                    need to succeed.
                    <br />
                    <br />
              ...
              >
                ...
                >
                  ...
                  <p>
                    ...
                    aspiring medical students succeed on the competitive exam.
                    Include study materials, practice tests and strategies for
                    managing stress. Helps students realize their full
                    potential.
                  </p>
                  <button
                    className="btn-primary"
