          ...
          <div className={styles.benefit_slider_wrapper} style={{ transform: `translateX(${sliderStatus[1]}px)` }}>
            ...
            <div className={styles.benefit_child} ref={sliderChildRef}>
              <div className={styles.benefit_left}>
                ...
                <button className="btn-primary" onClick={() => router.push('/contact')}>Book a free trial</button>
              </div>
            ...
            <Carousel dots={true}>
              <div className={styles.benefit_child}>
                <div className={styles.benefit_left}>
                  ...
                  <button className="btn-primary" onClick={() => window.location.href ='https://admin.mydopaclass.com/download'}>Schedule a Trial Class</button>
                </div>
                ...
                <Carousel itemsPerWindow={isMobile ? false : 2} dots={isMobile ? true : false} gap={16}>
                  <div className={styles.benefits_mobile_slide_card + " " + styles.benefits_card_colored}>
                    ...
                    <div className="downloads-wrapper">
                      <Image onClick={() => window.location.href ='https://admin.mydopaclass.com/download'} src={downloadAppStore} className={styles['download-img']} alt="Download Dopa appstore" />
                      <Image onClick={() => window.location.href ='https://admin.mydopaclass.com/download'} src={downloadPlayStore} className={styles['download-img']} alt="Download Dopa playstore" />
                    </div>
                  </div>
                    ...
                    <div className={styles.benefits_container_slider}>
                      <Carousel itemsPerWindow={isMobile ? false : 2} dots={isMobile ? true : false} gap={16}>
                        <div className={styles.benefits_mobile_slide_card + " " + styles.benefits_card_colored}>
                          ...
                          <button className="btn-primary btn-light" onClick={() => router.push('/contact')}>Schedule a Trial Class</button>
                        </div>
