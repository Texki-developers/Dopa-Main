  ...
  return (
    <div id="aboutus" className={styles["dopa-footer_container"]}>
      <div className={styles["footer-logo-container-mobile"]}>
        <div className={styles["footer-mobile-links-wrapper"]}>
          <div className={styles["footer-dopa_deatails-mobile"]}>
            <LinkCard
              para="DOPA (DOCTOR'S OWN PREP ACADEMY) VELLIPARAMBA POST KOZHIKODE PIN 673008 LANDMARK-RELIANCE SMART POINT"
              logo={
                <BiMapAlt
          ...
          <div className={styles["footer-social_media-mobile"]}>
            ...
            <div className={styles["social-icons"]}>
              <FiYoutube
                onClick={() =>
                  (window.location.href = "https://youtube.com/c/DOPACoaching")
                }
                style={{ fontSize: "2rem" }}
              />
              <AiOutlineInstagram
                onClick={() =>
                  (window.location.href =
                    "https://www.instagram.com/dopacoaching/?ig")
                }
                style={{ fontSize: "2rem" }}
              />
              <FiFacebook
                onClick={() =>
                  (window.location.href =
                    "https://www.facebook.com/dopacoaching/")
                }
        ...
        <p className={styles["dopa-copyright-mobile"]}>
          Copyright © 2024-2025 DOPA Coaching All rights reserved.
        </p>
      </div>
      ...
      <div className={styles["footer-dopa_deatails"]}>
        ...
        <LinkCard
          action={() => {
            window.location.href = "tel:+91 9645302200";
          }}
          para=" +91 9645202200"
          logo={
            <FiPhone className={styles["phone"]} style={{ fontSize: "2rem" }} />
          }
        />
        <LinkCard
          action={(e) => {
          ...
          para="info@dopacoaching.com"
          logo={
            <FiSend className={styles["mail"]} style={{ fontSize: "2rem" }} />
          }
        />
        <LinkCard
          para="privacy Policy"
      ...
      <p className={styles["dopa-copyright"]}>
        Copyright © 2024-2025 DOPA Coaching All rights reserved.
      </p>
    </div>
  );
